...
class Trainer(object):
    ...
    def train_phase(self, epochs, model):
        ...
        for epoch in range(epochs):
            ...
            print(
                'Epoch: {}  Train Loss: {:0.4f}  Train Accuracy: {:0.4f}  Validation Loss: {:0.4f} Validation Accuracy: {:0.4f}'.format(
                    epoch + 1, train_loss_epoch, train_accuracy_epoch, test_loss_epoch, test_accuracy_epoch))
